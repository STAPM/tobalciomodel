...
govtdemand2018 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                              sheet = "Table 2 - Final Demand 2018",
                              range = "E6:E110",
                              col_names = FALSE)
...
setnames(govtdemand2018 , old = names(govtdemand2018), new = c("govt.demand"))
...
data2018 <- cbind(sector,iotable2018,hholddemand2018,govtdemand2018,finaldemand2018,hholdoutput2018,totaloutput2018,totaldemand2018,gva2018)
data2018[, year := 2018]
rm(iotable2018,hholddemand2018,govtdemand2018,finaldemand2018,hholdoutput2018,totaloutput2018,totaldemand2018,gva2018)
...
govtdemand2017 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2017",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2017 , old = names(govtdemand2017) , new = c("govt.demand"))
...
data2017 <- cbind(sector,iotable2017,hholddemand2017,govtdemand2017,finaldemand2017,hholdoutput2017,totaloutput2017,totaldemand2017,gva2017)
data2017[, year := 2017]
rm(iotable2017,hholddemand2017,govtdemand2017,finaldemand2017,hholdoutput2017,totaloutput2017,totaldemand2017,gva2017)
...
govtdemand2016 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2016",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2016 , old = names(govtdemand2016) , new = c("govt.demand"))
...
data2016 <- cbind(sector,iotable2016,hholddemand2016,govtdemand2016,finaldemand2016,hholdoutput2016,totaloutput2016,totaldemand2016,gva2016)
data2016[, year := 2016]
rm(iotable2016,hholddemand2016,govtdemand2016,finaldemand2016,hholdoutput2016,totaloutput2016,totaldemand2016,gva2016)
...
govtdemand2015 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2015",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2015 , old = names(govtdemand2015) , new = c("govt.demand"))
...
data2015 <- cbind(sector,iotable2015,hholddemand2015,govtdemand2015,finaldemand2015,hholdoutput2015,totaloutput2015,totaldemand2015,gva2015)
data2015[, year := 2015]
rm(iotable2015,hholddemand2015,govtdemand2015,finaldemand2015,hholdoutput2015,totaloutput2015,totaldemand2015,gva2015)
...
govtdemand2014 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2014",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2014 , old = names(govtdemand2014) , new = c("govt.demand"))
...
data2014 <- cbind(sector,iotable2014,hholddemand2014,govtdemand2014,finaldemand2014,hholdoutput2014,totaloutput2014,totaldemand2014,gva2014)
data2014[, year := 2014]
rm(iotable2014,hholddemand2014,govtdemand2014,finaldemand2014,hholdoutput2014,totaloutput2014,totaldemand2014,gva2014)
...
govtdemand2013 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2013",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2013 , old = names(govtdemand2013) , new = c("govt.demand"))
...
data2013 <- cbind(sector,iotable2013,hholddemand2013,govtdemand2013,finaldemand2013,hholdoutput2013,totaloutput2013,totaldemand2013,gva2013)
data2013[, year := 2013]
rm(iotable2013,hholddemand2013,govtdemand2013,finaldemand2013,hholdoutput2013,totaloutput2013,totaldemand2013,gva2013)
...
govtdemand2012 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2012",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2012 , old = names(govtdemand2012) , new = c("govt.demand"))
...
data2012 <- cbind(sector,iotable2012,hholddemand2012,govtdemand2012,finaldemand2012,hholdoutput2012,totaloutput2012,totaldemand2012,gva2012)
data2012[, year := 2012]
rm(iotable2012,hholddemand2012,govtdemand2012,finaldemand2012,hholdoutput2012,totaloutput2012,totaldemand2012,gva2012)
...
govtdemand2011 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2011",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2011 , old = names(govtdemand2011) , new = c("govt.demand"))
...
data2011 <- cbind(sector,iotable2011,hholddemand2011,govtdemand2011,finaldemand2011,hholdoutput2011,totaloutput2011,totaldemand2011,gva2011)
data2011[, year := 2011]
rm(iotable2011,hholddemand2011,govtdemand2011,finaldemand2011,hholdoutput2011,totaloutput2011,totaldemand2011,gva2011)
...
govtdemand2010 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2010",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2010 , old = names(govtdemand2010) , new = c("govt.demand"))
...
data2010 <- cbind(sector,iotable2010,hholddemand2010,govtdemand2010,finaldemand2010,hholdoutput2010,totaloutput2010,totaldemand2010,gva2010)
data2010[, year := 2010]
rm(iotable2010,hholddemand2010,govtdemand2010,finaldemand2010,hholdoutput2010,totaloutput2010,totaldemand2010,gva2010)
...
govtdemand2009 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2009",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2009 , old = names(govtdemand2009) , new = c("govt.demand"))
...
data2009 <- cbind(sector,iotable2009,hholddemand2009,govtdemand2009,finaldemand2009,hholdoutput2009,totaloutput2009,totaldemand2009,gva2009)
data2009[, year := 2009]
rm(iotable2009,hholddemand2009,govtdemand2009,finaldemand2009,hholdoutput2009,totaloutput2009,totaldemand2009,gva2009)
...
govtdemand2008 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2008",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2008 , old = names(govtdemand2008) , new = c("govt.demand"))
...
data2008 <- cbind(sector,iotable2008,hholddemand2008,govtdemand2008,finaldemand2008,hholdoutput2008,totaloutput2008,totaldemand2008,gva2008)
data2008[, year := 2008]
rm(iotable2008,hholddemand2008,govtdemand2008,finaldemand2008,hholdoutput2008,totaloutput2008,totaldemand2008,gva2008)
...
govtdemand2007 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2007",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2007 , old = names(govtdemand2007) , new = c("govt.demand"))
...
data2007 <- cbind(sector,iotable2007,hholddemand2007,govtdemand2007,finaldemand2007,hholdoutput2007,totaloutput2007,totaldemand2007,gva2007)
data2007[, year := 2007]
rm(iotable2007,hholddemand2007,govtdemand2007,finaldemand2007,hholdoutput2007,totaloutput2007,totaldemand2007,gva2007)
...
govtdemand2006 <- read_excel(paste0(filepath,"1997 - 2018 ONS IO tables.xlsx"),
                             sheet = "Table 2 - Final Demand 2006",
                             range = "E6:E110",
                             col_names = FALSE)
...
setnames(govtdemand2006 , old = names(govtdemand2006) , new = c("govt.demand"))
...
data2006 <- cbind(sector,iotable2006,hholddemand2006,govtdemand2006,finaldemand2006,hholdoutput2006,totaloutput2006,totaldemand2006,gva2006)
data2006[, year := 2006]
rm(iotable2006,hholddemand2006,govtdemand2006,finaldemand2006,hholdoutput2006,totaloutput2006,totaldemand2006,gva2006)
